                        ...
                        <div class="container d-flex justify-content-center mt-50 mb-50">
                            ...
                            <div class="col-md-10">
                                ...
                                <form class="form mb-5 row g-3">
                                    ...
                                    <div class="col-md">
                                        <input type="password" placeholder="Product Name" />
                                    </div>
                                    ...
                                    <div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
                                        ...
                                        <div class="media-body mx-2">
                                            ...
                                            <ul class="list-inline list-inline-dotted mb-3 mb-lg-2">
                                                ...
                                                <li class="list-inline-item">${productID}</li>
                                            </ul>

                                                <p class="mb-2 mt-3 font-weight-semibold">Description: <p>${description}</p> </p>
                                        </div>

                                        <div class="mx-3 my-3 ml-lg-3 text-center">
                                            <h3 class="mt-3 font-weight-semibold">₱${price}</h3>

                                            <ul class="list-inline list-inline-dotted mt-3">
                                                <li class="list-inline-item">Size <li class="list-inline-item">${size}</li></li>
                                                <li class="list-inline-item">Quantity <li class="list-inline-item">${quantity}</li></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
